...
get = get_settings_profile(
  parameters =  c("L_at_Amin_Fem_GP_1", "L_at_Amin_Mal_GP_1", "L_at_Amax_Fem_GP_1",  "L_at_Amax_Mal_GP_1", "NatM_uniform_Fem_GP_1", "NatM_uniform_Mal_GP_1", "SR_BH_steep", "SR_LN(R0)"),
  low =  c(15, 13, 44.0, 44.0, 0.08, 0.08, 0.30, -0.5),
  high = c(22, 20, 52.0, 52.0, 0.14, 0.14, 0.95,  1.5),
  step_size = c(1, 1, 1, 1, 0.01, 0.01, 0.05, 0.10),
  param_space = c('real', 'real','real', 'real', 'real', 'real', 'real', 'relative'),
  use_prior_like = c(0, 0, 0, 0, 1, 1, 1, 0)
)
