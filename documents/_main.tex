...
Tables \ref{tab:north-referenceES} and \ref{tab:south-referenceES} show the full suite of estimated reference points for each sub-area model and Figures \ref{fig:south-es-yield} and \ref{fig:north-es-yield} show the equilibrium yield curves and net production based on a steepness value fixed at 0.72.
...
\begin{enumerate}
 ...
 \item Larval and smaller young-of-the-year copper rockfish can only be identified with certainty genetically. Existing sources of data (CalCOFI and Standard Monitoring Units for the Recruitment of Fishes [SMURFs]) where genetic samples can be analyzed would provide key information to inform recruitment for copper rockfish.
...
The SWFSC and UCSB both conduct visual surveys using ROVs and submersibles. We used the observations of copper rockfish from these data to inform our understanding of the distribution of copper rockfish and to ensure that the available survey and fishery data were representative of the distribution of copper rockfish from these additional data sources. The visual surveys ranged from 1993 to 2018 from Monterey south to the California/Mexico border. Observations from a total of 3,976 individual copper rockfish were observed at average transect depths ranging from 20 to 156 m, with an average of 67 m. The depth ranges of these surveys, especially dives from the 2007 submersible survey of the Southern California Bight extended into much deeper waters to cover the depth range of cowcod (Yoklavich et al. (2007)).
