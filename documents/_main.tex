...
\includegraphics[width=1\textwidth,height=1\textheight]{C:/Users/melissa.monk/Documents/GitHub/copper_rockfish_2023/documents/shared_figures/depletion_combined.png} \clearpage
...
Tables \ref{tab:north-referenceES} and \ref{tab:south-referenceES} shows the full suite of estimated reference points for each sub-area model and Figures \ref{fig:south-es-yield} and \ref{fig:north-es-yiedl} show the equilibrium yield curves and net production based on a steepness value fixed at 0.72.
