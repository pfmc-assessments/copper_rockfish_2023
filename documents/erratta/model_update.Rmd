...
table_format(x = tab,
             caption = "Time series of population estimates from the base model for the sub-area south of Point Conception.",
             label = "tab-south-ts",
             align = 'l',
             digits = 3,
             col_names = col_names)
...
table_format(x = tab,
             caption = "Time series of population estimates from the base model for the sub-area north of Point Conception.",
             label = "tab-north-ts",
             align = 'l',
             digits = 3,
             col_names = col_names)
