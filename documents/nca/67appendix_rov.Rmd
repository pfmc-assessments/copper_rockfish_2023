...
tab <- read.csv(file.path(data_dir, "survey_indices", "rov", "forSS", "rov_north_model_selection.csv"))
...
ind <- read.csv(file.path(data_dir, "survey_indices", "rov", "delta_lognormal_north_designation_depth", "index_forSS.csv"))
ind <- ind[, c(1,4,5)]
...
```{r, results = 'asis'}
sa4ss::add_figure(
filein = file.path(data_dir, "survey_indices", "rov", "delta_lognormal_north_designation_depth", "qq.png"), 
...
```{r, results = 'asis'}
sa4ss::add_figure(
filein = file.path(data_dir, "survey_indices", "rov", "delta_lognormal_north_designation_depth", "Index.png"), 
