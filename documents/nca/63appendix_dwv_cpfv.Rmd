...
by CDFW survey in California north of Point Conception from 1987-1998 and referred to as the Deb 
Wilson-Vandenberg onboard observer survey, @reilly-onboard-1998. During an onboard 
...
sheets for this survey and developed into a relational database @monk-documentation-2016. 
...
excluded from the analysis (Table \@ref(tab:deb-filte)). Sampling 
...
Moss Landing to Big Sur (V3), San Luis Obispo county to Point Conception (V4).  The ports in San 
...
ends of the distributions, removal of drifts occurring in depths outside copper rockfish's range 
(Table \@ref(tab:deb-filter) and Figure \@ref(fig:deb-depths)). 
We retained 5,546 drifts for index standardization, with 
1,389 fishing location encountering copper rockfish.  
...
hours were summed across drfts at a fishing stop. To explore weighting of the onboard observer survey index by the available 
...
region, and continuous depth and depth-squared.  
