...
alt_caption = "Indices of abundance that show improbable estimates of CPUE among counties and indicate a noisy dataset from the MRFSS period of sampling.",
...
alt_caption = "Additions and updates of data including fleet structure biology removals lengths and ages and fishery indices did not result in large overall changes in the model.  Addition of fishery lengths and ages and indices estimated a higher spawning output in the last three years of the model.", label = 'data-bridge-ssb-1')
```
...
alt_caption = "Additions and updates of data including fleet structure biology removals lengths and ages and fishery indices did not result in large overall changes in the model.  Addition of fishery lengths and ages and indices estimated a higher fraction of unfished in the last three years of the model.", label = 'data-bridge-depl-1')
```
...
alt_caption = "Bias adjustment ramps up linearly from 0 to 0.90 between 1966-2003 constant at 0.90 between 2003-2016 and then ramps down to 0 between 2016-2022.", label = 'bias-adjust')
```
...
alt_caption = "The index was generally fit well but the model did not capture the observed decrease in the index from 1996-1998", label = 'dwv-cpfv-index-fit')
```
...
alt_caption = "Total biomass in metric tons is relatively unfished between the start of the model through 1960 with the spawning output sharply decreasing to low levels by 1990s remaining low until the early 2000s where biomass increases to the end of the time series.", label = 'tot-bio')
```
...
alt_caption = "Estimated fraction of unfished is relatively unfished between the start of the model through 1960 with the spawning output sharply decreasing to low levels by 1990s remaining low until the early 2000s where it increases until the end of the time series.", label = 'depl')
```
...
sa4ss::add_figure(
  ...
  caption = "Predicted proportion of zeroes from the Bayesian fit to the main effects model.",
    alt_caption = "The predicted proportion of zeroes is within 0.5% of the data.",
  label = "pr-prop-zero"
)
```
...
sa4ss::add_figure(
  ...
  caption = "Q-Q plot for the dockside PR survey.",
    alt_caption = "The qq plot indicates a relatively good fit with some diversion of the 1:1 line on the upper quantiles.",
  label = "pr-qq"
)
```
...
alt_caption = "A map showing the six sampling districts with district one and two south of Point Conception.",
...
alt_caption = "The length distribution of copper rockfish encountered on overnight trips is larger than on single day trips.",
...
<!--chapter:end:72appendix_management_split.rmd-->
