...
mean of CPUE by year was also higher in this area (Figure \@ref(fig:fig-areacpue-debwv))
...
Tables of the number of samples and positive observations by factors depth, region and year, 
can be found in Tables \@ref(tab:deb), \@ref(tab:tab-region-debwv), and 
...
from 2017-2020. The final index (Table \@ref(tab:index-ccfrp)) 
...
in the filtered data set (Figure \@ref(fig:fig-areacpue-ccfrp)). Figure \@ref(fig:fig-sitecpue-ccfrp) shows arithmetic 
