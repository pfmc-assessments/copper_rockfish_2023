...
author:
  ...
  - name: Julia Coates
    ...
    middle: H
    family: Coates
author_list: Monk, M.H., C.R. Wetzel, J. H. Coates
affiliation:
  - code: 1
...
sa4ss::table_format(x = ind,
             ...
             longtable = FALSE, label = "catch-example",
              align = "r",
             col_names = col_names)                         
```
...
sa4ss::table_format(x = ind,
             caption = "Number of copper rockfish observed during the CPFV trips sampled onboard by district and trip type from 2018-2019.",
              align = "r",
             longtable = FALSE, label = "onboard-coppers",
             col_names = col_names)                         
```
...
sa4ss::table_format(x = ind,
             caption = "Number of copper rockfish measured by district and trip type from the angler interviews in 2018-2019.",
              align = "r",
             longtable = FALSE, label = "copper-lengths",
             col_names = col_names)                         
```
...
sa4ss::table_format(x = ind,
             ...
             longtable = FALSE, label = "onboard-trips",
             landscape = TRUE,
             align = 'l',
             col_names = col_names)                         
```
...
sa4ss::table_format(x = ind,
             caption = "Number of CPFV logbook entries with at least one rockfish, grouped by region fished and trip type from 2018-2019.",
              align = "r",
             longtable = FALSE, label = "logbook-triptype",
             col_names = col_names)                         
```
