...
```{r, results = 'asis'}
add_figure(
filein = file.path(mod_loc, "plots", "comp_lendat_bubflt2mkt2_page2.png"), 
...
```{r, results = 'asis'}
add_figure(
filein = file.path(mod_loc, "plots", "comp_lendat_flt4mkt0_page2.png"), 
...
```{r, results = 'asis'}
add_figure(
filein = file.path(mod_loc, "plots", "comp_lendat_data_weighting_TA1.8_Rec_pr.png"), 
