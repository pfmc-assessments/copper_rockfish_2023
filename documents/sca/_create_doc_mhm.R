...
bridge_dir <- file.path(assess_dir, "models", "sca", "_bridging")

#point to the northern model for document
#model_dir <- here("models", "nca", north_model_name)
model_dir <- file.path(assess_dir, "models", "sca", south_model_name)
...
sens_dir <- file.path(assess_dir, "models", "sca", "_sensitivities")
