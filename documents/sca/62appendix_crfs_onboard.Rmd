...
(Table \@ref(tab:onboard-modelselect)). In southern California, whether a trip is a 1/2 day or 3/4 day or overnight 
...
Indices were fit via MLE from the sdmTMB package in R. The QQ plot for the negative binomial 
...
binomial model (Table \@ref(fig:onboard-qq)).
