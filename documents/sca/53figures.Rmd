...
```{r, results = 'asis'}
add_figure(
filein = file.path(mod_loc, "plots", "comp_lendat_bubflt1mkt2_page2.png"), 
...
```{r, results = 'asis'}
add_figure(
filein = file.path(mod_loc, "plots", "comp_lendat_data_weighting_TA1.8_Commercial_dead.png"), 
...
```{r, results = 'asis'}
add_figure(
filein = file.path(mod_loc, "plots", "comp_lendat_bubflt2mkt2.png"), 
...
```{r, results = 'asis'}
add_figure(
filein = file.path(mod_loc, "plots", "comp_lendat_data_weighting_TA1.8_Commercial_live.png"), 
...
```{r, results = 'asis'}
add_figure(
filein = file.path(mod_loc, "plots", "comp_lendat_data_weighting_TA1.8_Rec_cpfv.png"), 
...
```{r, results = 'asis'}
add_figure(
filein = file.path(mod_loc, "plots", "comp_lendat_data_weighting_TA1.8_Rec_private.png"), 
...
```{r, results = 'asis'}
add_figure(
filein = file.path(data_loc, "nwfsc_hkl", "maps", "Map_HL_Sites_lndscp.jpg"), 
...
```{r, results = 'asis'}
add_figure(
filein = file.path(data_loc, "nwfsc_hkl", "plots", "hkl_copper_by_site_count_all_years.png"), 
...
```{r, results = 'asis'}
add_figure(
filein = file.path(data_loc, "nwfsc_hkl", "plots", "hkl_observations_by_length_sex_area.png"), 
