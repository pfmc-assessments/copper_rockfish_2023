...
have not been any verifiction studies conducted to determine the uncertainty in angler reported 
unobserved catch.
...
replaced the Stephens-MacCall [@stephens_multispecies_2004] filtering approach. We retained 13,340 angler interviews for index standardization, with 3,739 including sampled examined copper rockfish (Table \@ref(tab:pr-filter)).  
