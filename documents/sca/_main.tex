...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/catch2 landings stacked.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/ts7_Spawning_output_with_95_asymptotic_intervals_intervals.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/ts9_Relative_spawning_output_intervals.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/ts11_Age-0_recruits_(1000s)_with_95_asymptotic_intervals.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/SPR2_minusSPRseries.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/SPR4_phase.png}
\caption{Phase plot of estimated 1-SPR versus fraction unfished for the base model.\label{fig:es-phase}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/yield2_yield_curve_with_refpoints.png}
...
The axes of uncertainty in the decision table is based on the uncertainty around the spawning biomass in 2023 (\(\sigma\) = 0 ) via the log(\(R_0\)) parameter. The \(\sigma\) value was used to identify the 12.5 and 87.5 percentiles of the asymptotic standard deviation for the current year, 2023, spawning biomass from the base model to identify the low and high states of nature (i.e., 1.15 standard deviations corresponding to the 12.5 and 87.5 percentiles). Once the 2023 spawning biomass for the low and high states of nature were identified a search across log(\(R_0\)) values were done to attain the current year spawning biomass values. The log(\(R_0\)) values that corresponded with the lower and upper percentiles were XX and XX.
...
L at Amin Fem GP 1 & 11.771 & 2 & (6, 25) & OK & 0 & None\\
L at Amax Fem GP 1 & 48.373 & 2 & (35, 54) & OK & 0 & None\\
VonBert K Fem GP 1 & 0.162 & 2 & (0.03, 0.35) & OK & 0 & None\\
CV young Fem GP 1 & 0.206 & 2 & (0.01, 1) & OK & 0 & None\\
CV old Fem GP 1 & 0.066 & 2 & (0.01, 1) & OK & 0 & None\\
Wtlen 1 Fem GP 1 & 0.000 & -9 & (0, 0.1) & NA & NA & None\\
Wtlen 2 Fem GP 1 & 3.190 & -9 & (2, 4) & NA & NA & None\\
Mat50\% Fem GP 1 & 33.700 & -9 & (10, 60) & NA & NA & None\\
...
L at Amin Mal GP 1 & 9.059 & 2 & (6, 25) & OK & 0 & None\\
L at Amax Mal GP 1 & 45.260 & 2 & (35, 54) & OK & 0 & None\\
VonBert K Mal GP 1 & 0.214 & 2 & (0.03, 0.35) & OK & 0 & None\\
CV young Mal GP 1 & 0.203 & 2 & (0.01, 1) & OK & 0 & None\\
CV old Mal GP 1 & 0.072 & 2 & (0.01, 1) & OK & 0 & None\\
Wtlen 1 Mal GP 1 & 0.000 & -9 & (0, 0.1) & NA & NA & None\\
Wtlen 2 Mal GP 1 & 3.150 & -9 & (2, 4) & NA & NA & None\\
CohortGrowDev & 1.000 & -9 & (0, 1) & NA & NA & None\\
FracFemale GP 1 & 0.500 & -9 & (0.01, 0.99) & NA & NA & None\\
SR LN(R0) & 5.484 & 1 & (2, 20) & OK & 0 & None\\
SR BH steep & 0.720 & -7 & (0.22, 1) & NA & NA & Full Beta (0.72, 0.16)\\
SR sigmaR & 0.600 & -99 & (0.15, 0.9) & NA & NA & None\\
SR regime & 0.000 & -99 & (-2, 2) & NA & NA & None\\
SR autocorr & 0.000 & -99 & (0, 0) & NA & NA & None\\
Early InitAge 16 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early InitAge 15 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early InitAge 14 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early InitAge 13 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early InitAge 12 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early InitAge 11 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early InitAge 10 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early InitAge 9 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early InitAge 8 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early InitAge 7 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early InitAge 6 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early InitAge 5 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early InitAge 4 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early InitAge 3 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early InitAge 2 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early InitAge 1 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
...
Early RecrDev 1919 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1920 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1921 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1922 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1923 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1924 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1925 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1926 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1927 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1928 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1929 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1930 & 0.001 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1931 & 0.001 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1932 & 0.001 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1933 & 0.001 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1934 & 0.001 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1935 & 0.001 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1936 & 0.001 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1937 & 0.001 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1938 & 0.001 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1939 & 0.001 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1940 & 0.001 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1941 & 0.001 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1942 & 0.001 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1943 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1944 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1945 & 0.000 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1946 & -0.001 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1947 & -0.001 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1948 & -0.002 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1949 & -0.004 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1950 & -0.006 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1951 & -0.008 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1952 & -0.012 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1953 & -0.017 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1954 & -0.022 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1955 & -0.029 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1956 & -0.037 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1957 & -0.043 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1958 & -0.046 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Early RecrDev 1959 & -0.042 & 5 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1960 & -0.018 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1961 & 0.009 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1962 & 0.032 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1963 & 0.047 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1964 & 0.088 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1965 & 0.193 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1966 & 0.332 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1967 & 0.594 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1968 & 1.318 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1969 & 0.350 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1970 & 0.402 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1971 & -0.127 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1972 & 0.012 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1973 & 0.528 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1974 & 0.027 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1975 & -0.134 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1976 & -0.196 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1977 & -0.172 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1978 & -0.189 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1979 & -0.308 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1980 & -0.340 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1981 & -0.242 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1982 & -0.320 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1983 & -0.466 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1984 & -0.147 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1985 & 0.258 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1986 & 0.034 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1987 & -0.059 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1988 & 0.171 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1989 & 0.283 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1990 & 0.465 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1991 & 0.391 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1992 & 0.096 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1993 & -0.363 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1994 & -0.389 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1995 & -0.106 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1996 & -0.541 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1997 & -0.751 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1998 & -0.396 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 1999 & 0.552 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 2000 & -0.560 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 2001 & -0.703 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 2002 & 0.078 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 2003 & 0.562 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 2004 & -0.041 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 2005 & -0.029 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 2006 & -0.756 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 2007 & 0.379 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 2008 & 0.194 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 2009 & 1.226 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 2010 & 1.364 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 2011 & 0.302 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 2012 & 0.909 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 2013 & 1.160 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 2014 & -0.166 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 2015 & -0.941 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 2016 & -0.226 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 2017 & -0.875 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 2018 & -1.512 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 2019 & -0.925 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 2020 & -0.350 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 2021 & -0.017 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
Main RecrDev 2022 & 0.006 & 2 & (-5, 5) & act & 0 & dev (NA, NA)\\
...
LnQ base Rec CPFV(3) & -9.143 & -1 & (-15, 15) & NA & NA & None\\
Q extraSD Rec CPFV(3) & 0.335 & 4 & (0.001, 0.5) & OK & 0 & None\\
LnQ base Rec Private(4) & -8.193 & -1 & (-15, 15) & NA & NA & None\\
Q extraSD Rec Private(4) & 0.190 & 4 & (0.001, 0.5) & OK & 0 & None\\
LnQ base CCFRP(5) & -6.058 & -1 & (-15, 15) & NA & NA & None\\
Q extraSD CCFRP(5) & 0.048 & 4 & (0.001, 0.5) & OK & 0 & None\\
LnQ base CDFW ROV(6) & -8.101 & -1 & (-15, 15) & NA & NA & None\\
Q extraSD CDFW ROV(6) & 0.059 & 4 & (0.001, 0.5) & OK & 0 & None\\
LnQ base NWFSC HKL(7) & -10.068 & -1 & (-15, 15) & NA & NA & None\\
Q extraSD NWFSC HKL(7) & 0.001 & 4 & (0.001, 0.5) & LO & 0 & None\\
LnQ base CRFS CPFV(8) & -14.307 & -1 & (-15, 15) & NA & NA & None\\
Q extraSD CRFS CPFV(8) & 0.239 & 4 & (0.001, 0.5) & OK & 0 & None\\
Size DblN peak Commercial dead(1) & 46.390 & 1 & (15, 55) & OK & 0 & None\\
Size DblN top logit Commercial dead(1) & -6.842 & -3 & (-7, 7) & NA & NA & None\\
Size DblN ascend se Commercial dead(1) & 5.475 & 3 & (-10, 10) & OK & 0 & None\\
Size DblN descend se Commercial dead(1) & 6.557 & 4 & (-10, 10) & OK & 0 & None\\
Size DblN start logit Commercial dead(1) & -20.000 & -9 & (-20, 30) & NA & NA & None\\
Size DblN end logit Commercial dead(1) & -4.427 & 4 & (-10, 10) & OK & 0 & None\\
Size DblN peak Commercial live(2) & 37.211 & 1 & (15, 55) & OK & 0 & None\\
Size DblN top logit Commercial live(2) & -6.842 & -3 & (-7, 7) & NA & NA & None\\
Size DblN ascend se Commercial live(2) & -5.335 & 3 & (-10, 10) & OK & 0 & None\\
Size DblN descend se Commercial live(2) & 3.693 & 4 & (-10, 10) & OK & 0 & None\\
Size DblN start logit Commercial live(2) & -20.000 & -9 & (-20, 30) & NA & NA & None\\
Size DblN end logit Commercial live(2) & -2.621 & 4 & (-10, 10) & OK & 0 & None\\
Size DblN peak Rec CPFV(3) & 31.008 & 2 & (15, 55) & OK & 0 & None\\
Size DblN top logit Rec CPFV(3) & -6.935 & -3 & (-7, 7) & NA & NA & None\\
Size DblN ascend se Rec CPFV(3) & 3.999 & 3 & (-10, 10) & OK & 0 & None\\
Size DblN descend se Rec CPFV(3) & 4.815 & 4 & (-10, 10) & OK & 0 & None\\
Size DblN start logit Rec CPFV(3) & -8.243 & -9 & (-20, 30) & NA & NA & None\\
Size DblN end logit Rec CPFV(3) & -1.704 & 4 & (-10, 10) & OK & 0 & None\\
Size DblN peak Rec Private(4) & 31.064 & 2 & (15, 55) & OK & 0 & None\\
Size DblN top logit Rec Private(4) & -6.935 & -3 & (-7, 7) & NA & NA & None\\
Size DblN ascend se Rec Private(4) & 3.585 & 3 & (-10, 10) & OK & 0 & None\\
Size DblN descend se Rec Private(4) & 4.198 & 4 & (-10, 10) & OK & 0 & None\\
Size DblN start logit Rec Private(4) & -8.243 & -9 & (-20, 30) & NA & NA & None\\
Size DblN end logit Rec Private(4) & -1.028 & 4 & (-10, 10) & OK & 0 & None\\
Size DblN peak CCFRP(5) & 34.771 & 2 & (15, 55) & OK & 0 & None\\
Size DblN top logit CCFRP(5) & -6.891 & -3 & (-7, 7) & NA & NA & None\\
Size DblN ascend se CCFRP(5) & 4.406 & 3 & (-10, 10) & OK & 0 & None\\
Size DblN descend se CCFRP(5) & -9.703 & -4 & (-10, 10) & NA & NA & None\\
Size DblN start logit CCFRP(5) & -20.000 & -9 & (-20, 30) & NA & NA & None\\
Size DblN end logit CCFRP(5) & 10.000 & -4 & (-10, 10) & NA & NA & None\\
Size DblN peak CDFW ROV(6) & 30.680 & 2 & (15, 55) & OK & 0 & None\\
Size DblN top logit CDFW ROV(6) & -6.891 & -3 & (-7, 7) & NA & NA & None\\
Size DblN ascend se CDFW ROV(6) & 6.592 & 3 & (-10, 10) & OK & 0 & None\\
Size DblN descend se CDFW ROV(6) & -9.703 & -4 & (-10, 10) & NA & NA & None\\
Size DblN start logit CDFW ROV(6) & -20.000 & -9 & (-20, 30) & NA & NA & None\\
Size DblN end logit CDFW ROV(6) & 10.000 & -4 & (-10, 10) & NA & NA & None\\
Size DblN peak NWFSC HKL(7) & 45.193 & 2 & (15, 55) & OK & 0 & None\\
Size DblN top logit NWFSC HKL(7) & -6.891 & -3 & (-7, 7) & NA & NA & None\\
Size DblN ascend se NWFSC HKL(7) & 4.922 & 3 & (-10, 10) & OK & 0 & None\\
...
Size DblN peak Commercial dead(1) BLK1repl 1916 & 38.390 & 2 & (15, 55) & OK & 0 & None\\
Size DblN peak Commercial dead(1) BLK1repl 2002 & 40.370 & 2 & (15, 55) & OK & 0 & None\\
Size DblN peak Commercial dead(1) BLK1repl 2017 & 42.901 & 2 & (15, 55) & OK & 0 & None\\
Size DblN ascend se Commercial dead(1) BLK1repl 1916 & 4.243 & 4 & (-10, 10) & OK & 0 & None\\
Size DblN ascend se Commercial dead(1) BLK1repl 2002 & 4.530 & 4 & (-10, 10) & OK & 0 & None\\
Size DblN ascend se Commercial dead(1) BLK1repl 2017 & 4.923 & 4 & (-10, 10) & OK & 0 & None\\
Size DblN end logit Commercial dead(1) BLK1repl 1916 & 7.682 & 5 & (-10, 10) & OK & 0 & None\\
Size DblN end logit Commercial dead(1) BLK1repl 2002 & 6.875 & 5 & (-10, 10) & OK & 0 & None\\
Size DblN end logit Commercial dead(1) BLK1repl 2017 & -3.293 & 5 & (-10, 10) & OK & 0 & None\\
Size DblN peak Commercial live(2) BLK2repl 1916 & 34.106 & 2 & (15, 55) & OK & 0 & None\\
Size DblN ascend se Commercial live(2) BLK2repl 1916 & 2.968 & 4 & (-10, 10) & OK & 0 & None\\
Size DblN peak Rec CPFV(3) BLK3repl 1916 & 27.369 & 3 & (15, 55) & OK & 0 & None\\
Size DblN peak Rec CPFV(3) BLK3repl 2000 & 33.917 & 3 & (15, 55) & OK & 0 & None\\
Size DblN ascend se Rec CPFV(3) BLK3repl 1916 & 3.668 & 4 & (-10, 10) & OK & 0 & None\\
Size DblN ascend se Rec CPFV(3) BLK3repl 2000 & 4.138 & 4 & (-10, 10) & OK & 0 & None\\
Size DblN descend se Rec CPFV(3) BLK3repl 1916 & 5.283 & 5 & (-10, 10) & OK & 0 & None\\
Size DblN descend se Rec CPFV(3) BLK3repl 2000 & 4.067 & 5 & (-10, 10) & OK & 0 & None\\
Size DblN end logit Rec CPFV(3) BLK3repl 1916 & -0.235 & 5 & (-10, 10) & OK & 0 & None\\
Size DblN end logit Rec CPFV(3) BLK3repl 2000 & -8.342 & 5 & (-10, 10) & OK & 0 & None\\
Size DblN peak Rec Private(4) BLK3repl 1916 & 29.218 & 3 & (15, 55) & OK & 0 & None\\
Size DblN peak Rec Private(4) BLK3repl 2000 & 36.231 & 3 & (15, 55) & OK & 0 & None\\
Size DblN ascend se Rec Private(4) BLK3repl 1916 & 3.751 & 4 & (-10, 10) & OK & 0 & None\\
Size DblN ascend se Rec Private(4) BLK3repl 2000 & 4.352 & 4 & (-10, 10) & OK & 0 & None\\
Size DblN descend se Rec Private(4) BLK3repl 1916 & 4.383 & 5 & (-10, 10) & OK & 0 & None\\
Size DblN descend se Rec Private(4) BLK3repl 2000 & 4.236 & 5 & (-10, 10) & OK & 0 & None\\
Size DblN end logit Rec Private(4) BLK3repl 1916 & -1.133 & 5 & (-10, 10) & OK & 0 & None\\
Size DblN end logit Rec Private(4) BLK3repl 2000 & -6.143 & 5 & (-10, 10) & OK & 0 & None\\*
\end{longtable}
\endgroup{}
\end{landscape}
\endgroup{}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/data_plot.png}
\caption{Summary of data sources used in the base model.\label{fig:data-plot}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/comp_lendat_bubflt1mkt0_page2.png}
\caption{Length composition data from the commercial dead fleet.\label{fig:com-dead-len-data}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/comp_lendat_data_weighting_TA1.8_Commercial_dead.png}
\caption{Mean length for commercial dead fleet with 95 percent confidence intervals.\label{fig:mean-com-dead-len-data}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/comp_lendat_bubflt2mkt0.png}
\caption{Length composition data from the commercial live fleet.\label{fig:com-live-len-data}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/comp_lendat_data_weighting_TA1.8_Commercial_live.png}
\caption{Mean length for commercial live fleet with 95 percent confidence intervals.\label{fig:mean-com-live-len-data}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/comp_lendat_bubflt3mkt0_page2.png}
\caption{Length composition data from the recreation CPFV fleet.\label{fig:rec-cpfv-len-data}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/comp_lendat_data_weighting_TA1.8_Rec_CPFV.png}
\caption{Mean length for recreational CPFV fleet with 95 percent confidence intervals.\label{fig:mean-rec-cpfv-len-data}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/comp_lendat_bubflt4mkt0_page2.png}
\caption{Length composition data from the recreation PR fleet.\label{fig:rec-pr-len-data}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/comp_lendat_data_weighting_TA1.8_Rec_Private.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/comp_lendat_bubflt7mkt0.png}
\caption{Length composition data from the NWFSC Hook and Line survey.\label{fig:hkl-len-data}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/comp_lendat_data_weighting_TA1.8_NWFSC_HKL.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/comp_lendat_bubflt6mkt0.png}
\caption{Length composition data from the CDFW ROV survey.\label{fig:rov-len-data}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/comp_lendat_data_weighting_TA1.8_CDFW_ROV.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/bio6_maturity.png}
\caption{Maturity as a function of length.\label{fig:maturity}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/bio9_fecundity_len.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/numbers5_ageerrorSD.png}
\caption{Ageing imprecision standard deviation of observed age in years.\label{fig:age-error}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/numbers10_ageerror_matrix_1.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/bio1_sizeatage.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/SR_curve.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{N:/Assessments/CurrentAssessments/copper_rockfish_2023/models/sca/0.1_init_model/plots/ts1_Total_biomass_(mt).png}
...
\bottomrule
\endlastfoot
2015 & 0.2359408 & 0.1165455\\
2020 & 0.2246912 & 0.1181478\\*
\end{longtable}
\endgroup{}
\endgroup{}
